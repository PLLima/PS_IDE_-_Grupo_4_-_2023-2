...
export default function Starters(props){
    return(
        ...
        <div className={styles.container}>
            ...
            <imagens>
                <div><img src='/images/tipos/Agua_longo.png' style= {{width: '130px', height: '59px'}}/></div>
                <div><img src='/images/tipos/Planta_longo.png' style= {{width: '130px', height: '59px'}}/></div>
                <div><img src='/images/tipos/Fogo_longo.png' style= {{width: '130px', height: '59px'}}/></div>
            </imagens>
            <ide>
